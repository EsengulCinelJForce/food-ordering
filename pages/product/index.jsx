...
import { useDispatch, useSelector } from "react-redux"; //selector : store.js içindeki cart ı çağırmak için
...
const Index = () => {
  ...
  const [extraItems, setExtraItems] = useState(itemsExtra); //map ile döndürelim ki o bilgiyi alalım
  ...
  const handleChange = (e, item) => {
    ...
    // console.log(checked) //true false döndürür
  ...
  const handleClick = () =>{    //tıkladığımda cart a ekleme yaptırcaz
